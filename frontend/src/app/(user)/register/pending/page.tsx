export default function RegistrationPending() {
  return (
    <div className="w-[1440px] h-[1024px] relative bg-orange-50 rounded-br-[19px]">
      ...
      <div className="left-[476px] top-[126px] absolute text-orange-500 text-5xl font-bold font-['Maven Pro'] leading-normal">
        Registration Pending
      </div>
      <div className="w-[1369px] h-[680px] left-[30px] top-[180px] absolute">
        <div className="w-[1369px] h-[680px] left-0 top-0 absolute bg-zinc-700 bg-opacity-50 rounded-[17px]" />
        <div className="w-[600px] left-[390px] top-[268px] absolute text-center">
          <span className="text-white text-2xl font-bold font-['Maven Pro'] leading-normal">
            An verification email will be sent to:
            <br />
            <br />
          </span>
          ...
          <span className="text-white text-2xl font-bold font-['Maven Pro'] leading-normal">
            <br />
            Follow the directions provided in the email to continue with the
            login process.
            <br />
          </span>
        </div>
