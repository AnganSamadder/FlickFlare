...
export default function Login({}) {
  return (
    <div className="w-[1440px] h-[1024px] align-top relative bg-black rounded-br-[19px]">
      <div className="left-[1085px] top-[100px] absolute text-orange-500 text-5xl font-bold font-['Maven Pro'] leading-normal">
        Login
      </div>
      <div className="left-[765px] top-[280px] p-10 absolute">
      ...
      <div className="w-[340px] left-[980px] top-[890px] absolute">
