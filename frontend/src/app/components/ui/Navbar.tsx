        ...
        <div className="inset-0 bg-gradient-to-r from-amber-500 to-red-500 rounded-full">
            <button className="p-[3px] pr-[1.5px] relative" onClick={props.onClick}>
                {props.showing === "currently-running" ? (
                    ...
                    <div
                        className="px-8 py-2 bg-black rounded-l-full relative group transition duration-300 text-white hover:bg-transparent">
                        Currently Running
                    </div>
                )}
            </button>
            <button className="p-[3px] pl-[1.5px] relative" onClick={props.onClick1}>
                {props.showing === "coming-soon" ? (
                    ...
                    <div
                        className="px-8 py-2 bg-black rounded-r-full relative group transition duration-300 text-white hover:bg-transparent">
                        Coming Soon
                    </div>
                )}
            </button>
