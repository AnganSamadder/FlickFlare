...
export default function Profile() {
  return (
    <div className="h-screen relative bg-black rounded-br-[19px]">
      <div className="w-screen left-[548px] top-[116px] absolute text-orange-500 text-5xl font-bold font-['Maven Pro'] leading-normal">
        Edit Profile
      </div>
